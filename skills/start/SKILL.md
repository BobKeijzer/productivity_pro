...
- `memory/updates/` — changelogs from update runs (DD-MM-YYYY.md)
...
The update skill reads across all your chats in this project (filtered by workspace — other projects are excluded).
```
